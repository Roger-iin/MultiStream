        ...
        {platforms.map(({ key, label, icon, activeColor }) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col md:flex-row items-center justify-center gap-1.5 md:gap-2 px-4 py-2.5 md:py-2 rounded-xl border font-semibold text-xs transition-all duration-200 cursor-pointer ${isSelected
                ? activeColor
